...
TWITTER_SOURCE_ACCOUNTS = ["level22skeleton"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "_killaaron"  # The name of the account you're tweeting to.

...
```
heroku config:set TWITTER_CONSUMER_KEY=qnInX8JM3gMXPt3cJAFSNQRUq
heroku config:set TWITTER_CONSUMER_SECRET=2QeEnpPr5lB8X7OuCJrGlRNRGaIEJZnWvT9roVc9v88lNjdjcI
heroku config:set TWITTER_ACCESS_TOKEN_KEY=1128381130753892352-RZii0D2atXi6Nt5GZsuCcaYCAwdH0x
heroku config:set TWITTER_ACCESS_SECRET=VBPoVWwGGhJJ137LAaJnlb2KSLIsLeBgfrwpwKJb9ym7j
```

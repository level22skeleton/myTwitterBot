...
```
heroku config:set TWITTER_CONSUMER_KEY=gww7r5P6psPQ7Xzrb0aHmCVLU
heroku config:set TWITTER_CONSUMER_SECRET=eWbDMH3d6vUHRKfXXguITqGYLJBeiWpYFoZPDkiInVTKhFEzPn
heroku config:set TWITTER_ACCESS_TOKEN_KEY=1128381130753892352-kAR7cITjl7J6Fm1YgNaPPUZLfAeLTQ
heroku config:set TWITTER_ACCESS_SECRET=uUKJWFBNuzQrjw45gajUbmhpErqMZUKzX6DO7Qb8OtzWv
```
